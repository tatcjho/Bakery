...
<div class="container">
    <h1>Productos</h1>
    <?php echo "<a href='../viewCart.php?usu_codigo=' class='cart-link' title='View Cart'><i class='glyphicon glyphicon-shopping-cart'></i></a>";?>
    <div id="products" class="row list-group">
        <?php
       
        $query = $conn->query("SELECT * FROM producto WHERE cat_id=3");
        if($query->num_rows > 0){ 
        ...
        <div class="item col-lg-4">
            <div class="thumbnail">
                <div class="caption">
                    ...
                    <img class='card-img-top' src='../../../images/tortas/<?php echo $row["produ_imagen"]; ?>' alt='' width="300px" height="200px">
                    <div class="row">
                        <div class="col-md-6">
