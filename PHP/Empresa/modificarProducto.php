...
<body>
    ...
    <div id="derecha">
        ...
        <?php
        $codigo=$_GET["codigo"];
        $sql="SELECT * FROM producto WHERE produ_codigo=$codigo and cat_id=1";
        $sql1="SELECT * FROM producto WHERE produ_codigo=$codigo and cat_id=2";
        $sql2="SELECT * FROM producto WHERE produ_codigo=$codigo and cat_id=3";
        ...
        if($result->num_rows > 0){
            while($row=$result->fetch_assoc()){
                ...
                <form id="formulario01" method="post" action="Controladores/modificarProducto.php">
                    ...
                    <input type="text" id="categoria" name="categoria" value="<?php echo $row["cat_id"]; ?>" required placeholder="Ingrese la fecha de nacimiento"/>
                    <br>
            ...
            while($row1=$result1->fetch_assoc()){
                ...
                <form id="formulario01" method="post" action="Controladores/modificarProducto.php">
                    ...
                    <br>
                    <label for="categoria" id="label1">Categoria</label>
                    <input type="text" id="categoria" name="categoria" value="<?php echo $row1["cat_id"]; ?>" required placeholder="Ingrese la fecha de nacimiento"/>
                    <br>
                    <input type="submit" id="submit" name="modificar" value="Modificar"/>
                    <input type="reset" id="cancelar" name="cancelar" value="Cancelar"/>
                </form>
            ...
            while($row2=$result2->fetch_assoc()){
                ...
                <form id="formulario01" method="post" action="Controladores/modificarProducto.php">
                    ...
                    <br>
                    <label for="categoria" id="label1">Categoria</label>
                    <input type="text" id="categoria" name="categoria" value="<?php echo $row2["cat_id"]; ?>" required placeholder="Ingrese la fecha de nacimiento"/>
                    <br>
                    <input type="submit" id="submit" name="modificar" value="Modificar"/>
                    <input type="reset" id="cancelar" name="cancelar" value="Cancelar"/>
                </form>
